 ...
 * @subpackage Fury
 */
if ( ! class_exists( 'Fury_Control_Upsell_Theme_Info' ) ) :

	/**
	 * Fury_Control_Upsell_Theme_Info class.
	 */
	class Fury_Control_Upsell_Theme_Info extends WP_Customize_Control {
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Fury_Control_Upsell_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'themevision-upsell-style', fury_modules_url . 'fury-upsell/css/style.css', fury_version );
		}
