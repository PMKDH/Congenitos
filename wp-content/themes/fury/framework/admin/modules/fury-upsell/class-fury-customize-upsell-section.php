 ...
 */
/**
 * Class Fury_Customizer_Upsell_Section
 */
class Fury_Customizer_Upsell_Section extends WP_Customize_Section {
	...
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Fury_Customizer_Upsell_Section' );
