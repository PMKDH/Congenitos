...
<div class="erf-wrapper">
    <div id="erf_uninstall_feedback_dialog" class="erf-modal-wrap" style="display:none;">

        <div class="erf-content-wrap">

            <div class="erf-modal-header">Easy Registration Forms Feedback
                <span class="erf-modal-close">×</span>
            </div>


            <div class="erf-modal-content">
                ...
                <div class="erf-child-rows"  id="erf_feedback_broken">
                    <div class="erf-row">
                        <input class="erf-feedback-text" type="text" id="erf_plugin_broke_site" name="erf_plugin_broke_site" placeholder="Issue Details">
                ...
                <div class="erf-child-rows" id="erf_feedback_feature">
                    <div class="erf-row">
                        <input class="erf-feedback-text" type="text" id="erf_feature_not_available" name="erf_feature_not_available" placeholder="Please let us know the missing feature...">
                    </div>
                </div>
                ...
                <div class="erf-child-rows" id="erf_feedback_plugin">
                    <div class="erf-row">
                        <input class="erf-feedback-text" type="text" id="erf_different_plugin" name="erf_different_plugin" placeholder="<?php _e('Plugin Name', 'erforms'); ?>">
                    </div>
                </div>
                ...
                <div class="erf-child-rows" id="erf_feedback_other">
                    <div class="erf-row">
                        <input class="erf-feedback-text" type="text" id="erf_other" name="erf_other" placeholder="<?php _e('Reason', 'erforms'); ?>">
                    </div>
                </div>

            </div>
            <div class="erf-modal-footer clearfix">
                <div class="erf-modal-button-wrap">
                    <button type="button" class="erf-cancel-button erf-modal-button" role="button">
                        <span class="erf-modal-button-text"><?php _e('Cancel', 'erforms'); ?></span>
                    </button>
                    <button type="button" class="erf-submit-btn erf-modal-button" role="button">
