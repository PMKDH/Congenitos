<div class="wrap erf-wrapper erf-wrapper-bg">
    ...
    <div class="erf-new-label">
        ...
        <form method="POST" class="erf-new-form flex-s-e">
            <div class="erf-label-name erf-label-wrap">
                ...
                <div class="label-input"><input class="form-control" required="" type="text" name="label_name" value="<?php echo isset($_POST['label_name']) ? $_POST['label_name'] : '' ?>" /></div>
            </div>
            
            <div class="erf-label-description erf-label-wrap">
                <div class="label"><?php _e('Description','erforms'); ?></div>
                <div class="label-input"><input type="text" name="label_desc" value="<?php echo isset($_POST['label_desc']) ? $_POST['label_desc'] : '' ?>" /></div>
            </div>
            
            <div class="erf-label-color erf-label-wrap">
                <div class="label"><?php _e('Color','erforms'); ?></div>
                <div class="label-input"><input required="" class="jscolor" type="text" value="<?php echo isset($_POST['label_color']) ? $_POST['label_color'] : erforms_rand_hex_color(); ?>"  name="label_color" /></div>
            </div>
        ...
        <table class="wp-list-table widefat fixed">
            ...
            <tbody>
                <?php foreach($labels as $label):?>
                    <tr class="erf-label-row" id="static_row_<?php echo $label['id']; ?>" data-label-id="<?php echo $label['id']; ?>">
                        <td>
                    ...
                    <tr style="display:none" class="erf-label-edit" id="form_row_<?php echo $label['id']; ?>" data-label-id="<?php echo $label['id']; ?>">
                            <td>
                                <div class="erf-label-name erf-label-wrap">
                                    <div class="label"><?php _e('Label Name','erforms'); ?></div>
                                    <div class="label-input"><input id="label" type="text" value="<?php echo $label['name']; ?>" name="label_name" /></div>
                                </div> 
                            </td> 
                            ...
                            <td>
                                <div class="erf-label-description erf-label-wrap">
                                    <div class="label"><?php _e('Description','erforms'); ?></div>
                                    <div class="label-input"><input id="desc" type="text" value="<?php echo $label['desc']; ?>" name="label_desc" /></div>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="erf-label-color erf-label-wrap">
                                    <div class="label"><?php _e('Color','erforms'); ?></div>
                                    <div class="label-input"><input id="color" class="jscolor"  value="<?php echo $label['color']; ?>" type="text" name="label_color" /></div>
                                </div>
                            </td>
            ...
            var data = {
             ...
             $.post(ajaxurl, data, function(response) {
                 ...
                 if(response.success){
                     ...
                     static_row.find('.color').css('background-color','#' + color);
