                ...
                <div class="erf-profile-details-wrap">
                    ...
                    <div class="erf-profile-details">
                        ...
                        <div class="erf-profile-logout">
                            <button onClick="location.href='<?php echo wp_logout_url(get_permalink()); ?>'"><?php _e('Logout','erforms'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        if (!empty($submissions)) {
                            foreach ($submissions as $index => $submission) :
                                ...
                                <div class="erf-my-account-details">
                                    ...
                                    <div class="erf-my-account-detail erf-my-account-col-form-name" data-submission-id="<?php echo $submission['id']; ?>">
                                        <a data-form-id="<?php echo $form['id']; ?>" data-submission-id="<?php echo $submission['id']; ?>" class="erf-load-submission-row" href="javascript:void(0)"><?php echo $form['title']; ?></a>
                                        <div  style="display:none" class="erf-modal">
                                            <div class="erf-submission-info">
                                                <div class="erf-modal-header">
                                                    ...
                                                    <?php echo $form['title']; ?>
                                                    <button class="erf-print-submission" onclick="erfPrintSubmission(this)"><i class="fa fa-print"></i></button>
                                                </div>
                                    ...
                                    <div class="erf-my-account-detail erf-my-account-col-edit">
                                        <a class="erf-edit-submission-row <?php echo empty($form['en_edit_sub']) ? 'erf-link-disabled' : ''; ?>" data-form-id="<?php echo $form['id']; ?>" data-submission-id="<?php echo $submission['id']; ?>" href="javascript:void(0)"><?php _e('Edit', 'erforms');  ?></a>
                                        <a class="erf-delete-submission-row <?php echo empty($form['allow_sub_deletion']) ? 'erf-link-disabled' : ''; ?>" data-form-id="<?php echo $form['id']; ?>" data-submission-id="<?php echo $submission['id']; ?>" href="javascript:void(0)"><?php _e('Delete', 'erforms');  ?></a>
