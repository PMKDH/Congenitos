...
(function($) {
    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        var AmsifySuggestags = function() {
            this.selector      = null;
            this.name          = null;
            this.defaultLabel  = settings.defaultLabel;
            this.classes       = {
        ...
        AmsifySuggestags.prototype = {
            ...
            addTag : function(value,initial) {
              ...
              if(this.isPresent(value)) {
                ...
                this.setRemoveEvent();
                this.setInputValue();
                if(!initial && settings.afterAdd && typeof settings.afterAdd == "function") {
            ...
            setIcon : function() {
              ...
              if(settings.type == 'bootstrap') {
                return '<span class="fa fa-times '+removeClass+'">x</span>';
