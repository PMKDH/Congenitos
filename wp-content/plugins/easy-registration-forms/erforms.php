    ...
    final class ERForms {
        ...
        public function set_common_objects() {
            ...
            // Global objects.
              ...
              $this->form = new ERForms_Form;
              $this->frontend   = new ERForms_Frontend;
              $this->submission    = new ERForms_Submission;
              $this->user    = new ERForms_User;
              $this->plan  = new ERForms_Plan;
              $this->label= new ERForms_Label();
