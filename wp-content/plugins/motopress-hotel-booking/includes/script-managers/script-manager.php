...
abstract class ScriptManager {
	...
	public function register(){
		wp_register_script( 'mphb-canjs', $this->scriptUrl( 'vendors/canjs/can.custom.min.js' ), array( 'jquery' ), MPHB()->getVersion(), true );
		$this->addDependency( 'mphb-canjs' );

		wp_register_script( 'mphb-kbwood-plugin', $this->scriptUrl( 'vendors/kbwood/datepick/jquery.plugin.min.js' ), array( 'jquery' ), MPHB()->getVersion(), true );
		wp_register_script( 'mphb-kbwood-datepick', $this->scriptUrl( 'vendors/kbwood/datepick/jquery.datepick.min.js' ), array( 'jquery', 'mphb-kbwood-plugin' ), MPHB()->getVersion(), true );
