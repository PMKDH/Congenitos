...
class RoomTypeCPT extends EditableCPT {
	...
	public function register(){
		...
		$args = array(
			'labels'				 => $labels,
			'description'			 => __( 'This is where you can add new accommodation types to your hotel.', 'motopress-hotel-booking' ),
			'public'				 => true,
	...
	public function getFieldGroups(){
		...
		$bedField = Fields\FieldFactory::create(
				...
				'description'	 => strtr( __( 'Set bed types list in <a href="%link%" target="_blank">settings</a>.', 'motopress-hotel-booking' ), array(
